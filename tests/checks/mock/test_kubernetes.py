...
class TestKubernetes(AgentCheckTest):
    ...
    def test_metrics_1_2(self):
        ...
        for m in self.metrics:
            if m[3]['tags'] == ['kube_replication_controller:kube-dns-v11']:
                import pdb; pdb.set_trace()

        """
[u'container_name:/kubelet', 'pod_name:no_pod']
[u'container_name:k8s_POD.e2764897_kube-dns-v11-63tae_kube-system_5754714c-0054-11e6-9a89-42010af00098_c33e4b64', u'io.kubernetes.container.name:POD', 'pod_name:kube-dns-v11-63tae', 'kube_namespace:kube-system', u'kube_k8s-app:kube-dns', u'kube_version:v11', u'kube_kubernetes.io/cluster-service:true', u'kube_replication_controller:kube-dns-v11']
[u'container_name:k8s_dd-agent.67c1e3c5_dd-agent-idydc_default_adecdd57-f5c3-11e5-8f7c-42010af00098_5154bb06', u'io.kubernetes.container.name:dd-agent', 'pod_name:dd-agent-idydc', 'kube_namespace:default', u'kube_app:dd-agent', u'kube_replication_controller:dd-agent']
[u'container_name:/', 'pod_name:no_pod']
[u'container_name:/docker-daemon', 'pod_name:no_pod']
[u'container_name:k8s_skydns.7ad23ad1_kube-dns-v11-63tae_kube-system_5754714c-0054-11e6-9a89-42010af00098_b082387b', u'io.kubernetes.container.name:skydns', 'pod_name:kube-dns-v11-63tae', 'kube_namespace:kube-system', u'kube_k8s-app:kube-dns', u'kube_version:v11', u'kube_kubernetes.io/cluster-service:true', u'kube_replication_controller:kube-dns-v11']
[u'container_name:k8s_healthz.4039147e_kube-dns-v11-63tae_kube-system_5754714c-0054-11e6-9a89-42010af00098_d8e1d132', u'io.kubernetes.container.name:healthz', 'pod_name:kube-dns-v11-63tae', 'kube_namespace:kube-system', u'kube_k8s-app:kube-dns', u'kube_version:v11', u'kube_kubernetes.io/cluster-service:true', u'kube_replication_controller:kube-dns-v11']
[u'container_name:/system', 'pod_name:no_pod']
[u'container_name:k8s_etcd.81a33530_kube-dns-v11-63tae_kube-system_5754714c-0054-11e6-9a89-42010af00098_e811864e', u'io.kubernetes.container.name:etcd', 'pod_name:kube-dns-v11-63tae', 'kube_namespace:kube-system', u'kube_k8s-app:kube-dns', u'kube_version:v11', u'kube_kubernetes.io/cluster-service:true', u'kube_replication_controller:kube-dns-v11']
[u'container_name:k8s_kube-proxy.cf23f4be_kube-proxy-gke-cluster-remi-62c0dd29-node-29lx_kube-system_f70c43857a22d5495bf204918d5ab984_4e315ef3', u'io.kubernetes.container.name:kube-proxy', 'pod_name:kube-proxy-gke-cluster-remi-62c0dd29-node-29lx', 'kube_namespace:kube-system', u'kube_replication_controller:kube-proxy-gke-cluster-remi-62c0dd29-node']
[u'container_name:k8s_kube2sky.8cbc016c_kube-dns-v11-63tae_kube-system_5754714c-0054-11e6-9a89-42010af00098_d6df3862', u'io.kubernetes.container.name:kube2sky', 'pod_name:kube-dns-v11-63tae', 'kube_namespace:kube-system', u'kube_k8s-app:kube-dns', u'kube_version:v11', u'kube_kubernetes.io/cluster-service:true', u'kube_replication_controller:kube-dns-v11']
[u'container_name:k8s_POD.35220667_dd-agent-idydc_default_adecdd57-f5c3-11e5-8f7c-42010af00098_e2c005a0', u'io.kubernetes.container.name:POD', 'pod_name:dd-agent-idydc', 'kube_namespace:default', u'kube_app:dd-agent', u'kube_replication_controller:dd-agent']
['kube_replication_controller:kube-dns-v11']
[u'container_name:k8s_POD.6059dfa2_kube-proxy-gke-cluster-remi-62c0dd29-node-29lx_kube-system_f70c43857a22d5495bf204918d5ab984_e17ace7a', u'io.kubernetes.container.name:POD', 'pod_name:kube-proxy-gke-cluster-remi-62c0dd29-node-29lx', 'kube_namespace:kube-system', u'kube_replication_controller:kube-proxy-gke-cluster-remi-62c0dd29-node']
[u'container_name:k8s_POD.6059dfa2_fluentd-cloud-logging-gke-cluster-remi-62c0dd29-node-29lx_kube-system_da7e41ef0372c29c65a24b417b5dd69f_b4d7ed62', u'io.kubernetes.container.name:POD', 'pod_name:fluentd-cloud-logging-gke-cluster-remi-62c0dd29-node-29lx', 'kube_namespace:kube-system', u'kube_k8s-app:fluentd-logging', u'kube_replication_controller:fluentd-cloud-logging-gke-cluster-remi-62c0dd29-node']
[u'container_name:k8s_fluentd-cloud-logging.fe59dd68_fluentd-cloud-logging-gke-cluster-remi-62c0dd29-node-29lx_kube-system_da7e41ef0372c29c65a24b417b5dd69f_3cacfb32', u'io.kubernetes.container.name:fluentd-cloud-logging', 'pod_name:fluentd-cloud-logging-gke-cluster-remi-62c0dd29-node-29lx', 'kube_namespace:kube-system', u'kube_k8s-app:fluentd-logging', u'kube_replication_controller:fluentd-cloud-logging-gke-cluster-remi-62c0dd29-node']
...
[u'container_name:k8s_fluentd-cloud-logging.fe59dd68_fluentd-cloud-logging-gke-cluster-remi-62c0dd29-node-29lx_kube-system_da7e41ef0372c29c65a24b417b5dd69f_3cacfb32', u'io.kubernetes.container.name:fluentd-cloud-logging', 'pod_name:fluentd-cloud-logging-gke-cluster-remi-62c0dd29-node-29lx', 'kube_namespace:kube-system', u'kube_k8s-app:fluentd-logging', u'kube_replication_controller:fluentd-cloud-logging-gke-cluster-remi-62c0dd29-node']
        ...
        expected_tags = [
            (['container_name:/kubelet', 'pod_name:no_pod'], [MEM, CPU, NET, DISK]),
            (['container_name:k8s_POD.e2764897_kube-dns-v11-63tae_kube-system_5754714c-0054-11e6-9a89-42010af00098_c33e4b64', 'io.kubernetes.container.name:POD', 'pod_name:kube-dns-v11-63tae', 'kube_namespace:kube-system', 'kube_k8s-app:kube-dns', 'kube_version:v11', 'kube_kubernetes.io/cluster-service:true', 'kube_replication_controller:kube-dns-v11'], [MEM, CPU, NET, DISK]),
            (['container_name:k8s_dd-agent.67c1e3c5_dd-agent-idydc_default_adecdd57-f5c3-11e5-8f7c-42010af00098_5154bb06', 'io.kubernetes.container.name:dd-agent', 'pod_name:dd-agent-idydc', 'kube_namespace:default', 'kube_app:dd-agent', 'kube_replication_controller:dd-agent'], [MEM, CPU, FS, NET, NET_ERRORS, DISK]),
            (['container_name:/', 'pod_name:no_pod'], [MEM, CPU, FS, NET, NET_ERRORS, DISK]),
            (['container_name:/docker-daemon', 'pod_name:no_pod'], [MEM, CPU, DISK, NET]),
            (['container_name:k8s_skydns.7ad23ad1_kube-dns-v11-63tae_kube-system_5754714c-0054-11e6-9a89-42010af00098_b082387b', 'io.kubernetes.container.name:skydns', 'pod_name:kube-dns-v11-63tae', 'kube_namespace:kube-system', 'kube_k8s-app:kube-dns', 'kube_version:v11', 'kube_kubernetes.io/cluster-service:true', 'kube_replication_controller:kube-dns-v11'], [MEM, CPU, FS, NET, DISK]),
